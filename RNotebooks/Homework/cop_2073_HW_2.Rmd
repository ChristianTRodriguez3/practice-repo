...
author: "Christian Rodriguez - `CRodriguez2061@floridapoly.edu`"
...
[GitHub repo Link](https://github.com/ChristianTRodriguez3/practice-repo)
...
![Screenshot of Repo](../images/Screenshotofrepo.jpg)
...
- How to use mark-up to add emphasis to your text
- How to use mark-up to create a table
- [Link to Markdown Tutorial](https://commonmark.org/help/tutorial/)
...
(d) Define a function called `add_three` that takes a single argument and returns a value 3 units larger than the input.
```{r}
# Creates the function add_tree that multiplies an input by 3
add_three <- function() {
  t <- as.integer(readline(prompt = "_ + 3 ="))
  print(paste(t,"+ 3 ="))
  t <- t+3
  print(t)
}
