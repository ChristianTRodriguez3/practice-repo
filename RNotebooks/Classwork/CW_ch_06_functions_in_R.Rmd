...
my_name <- make_full_name("Alice", "Kim")
my_name
```
...
calc_rect_area <- function(width, height) {
  return(width* height)
}
calc_rect_area(2,4)
...
add_title <- function(full_name, title) {
  ...
  print(name_with_title)
}
add_title("Christian", "Dr.")
```
